  ...
  return (
    <section id="mission" className="container care-section">
      ...
      <div className="care-head">
        ...
        <div 
          ref={labelRef}
          className={`how-label care-label-right fade-in-right ${labelShouldAnimate ? 'animate' : ''}`}
        >
          {`{ Миссия игры }`}
        </div>
      </div>
      ...
      <div className="care-grid">
        <div className="care-left">
          <div 
            ...
            aria-hidden
          >
            <svg viewBox="0 0 577 142" width="577" height="142" xmlns="http://www.w3.org/2000/svg">
